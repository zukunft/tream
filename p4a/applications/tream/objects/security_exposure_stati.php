...
*/
class Security_exposure_stati extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->security_exposure_stati);
		$this->firstRow();
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->security_exposure_stati)
		...
		$this->build("p4a_fieldset", "fs_details")
			->setLabel("Security_exposure stati detail")
		...
		$this
			...
			->setFocus($this->fields->status_text);
	}
}

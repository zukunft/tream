...
*/
class Security_price_feed_types extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->security_price_feed_types);
		$this->firstRow();
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->security_price_feed_types)
			->setWidth(500)
			->showNavigationBar();
		...
		$this->build("p4a_fieldset", "fs_details")
			->setLabel("Security price feed type name")

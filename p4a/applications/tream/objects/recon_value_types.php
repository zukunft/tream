...
*/
class Recon_value_types extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->recon_value_types);
		$this->firstRow();
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->recon_value_types)
			->setWidth(500)
			->showNavigationBar();
		...
		$this->build("p4a_fieldset", "fs_details")
			->setLabel("Reconciliation value type detail")

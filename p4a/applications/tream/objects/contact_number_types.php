...
class Contact_number_types extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->contact_number_types);
		$this->firstRow();
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->contact_number_types)
			->setVisibleCols(array("type_name"))
			->setWidth(500)
			->showNavigationBar();

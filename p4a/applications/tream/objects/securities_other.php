...
*/
class Securities_other extends P4A_Base_Mask
{
	...
	public function __construct()
	{
		...
		$this->build("p4a_db_source", "securities")
			...
			->setWhere("v_security_types.code_id <> 'equity' AND v_security_types.code_id <> 'bond' AND v_security_types.code_id <> 'fund' AND v_security_types.code_id <> 'ETF'") 
			->setPageLimit(30)
			->load();
		...
		$this->setTitle("Other securities");
		$this->firstRow();
		...
		$this->fields->currency_pair_id
			->setLabel("FX pair")
			->setType("select")
			->setSource(P4A::singleton()->select_currency_pairs)

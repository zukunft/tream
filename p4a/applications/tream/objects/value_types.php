...
*/
class Value_types extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->value_types);
		$this->firstRow();
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->value_types)
			->setVisibleCols(array("description","code_id","comment"))
			->setWidth(700)
			->showNavigationBar();

...
*/
class Security_field_values extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->setSource($p4a->security_field_values);
		$this->firstRow();
		...
		$this->fields->security_field_id
			->setLabel("Field")
			->setType("select")
			->setSource(P4A::singleton()->select_security_fields)
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->security_field_values)
			->setVisibleCols(array("security","field","sec_value","comment")) 
			->setWidth(500)
			->showNavigationBar();
		...
		$this->build("p4a_fieldset", "fs_details")
			...
			->anchor($this->fields->security_field_id)
			->anchor($this->fields->sec_value)

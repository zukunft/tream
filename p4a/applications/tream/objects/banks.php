...
*/
class Banks extends P4A_Base_Mask
{
	public $toolbar = null;
	public $table = null;
	...
	public function __construct()
	{
		...
		$this->build("p4a_table", "table")
			->setSource($p4a->banks)
			->setVisibleCols(array("bank_name","comment"))
			->setWidth(700)
			->showNavigationBar();

		$this->setRequiredField("bank_name");

		$this->build("p4a_fieldset", "fs_details")
			->setLabel("Bank detail")
			->anchor($this->fields->bank_name)
		...
		$this
			...
			->setFocus($this->fields->bank_name);
	}
}
